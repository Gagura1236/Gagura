...
def main():
    ...
    pd.DataFrame([xgb_m, rf_m]).to_csv(
        "./model_comparison_v1.1.csv", index=False, float_format="%.6f", encoding="utf-8-sig"
    )
